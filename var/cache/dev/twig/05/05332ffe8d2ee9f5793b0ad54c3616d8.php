...
class __TwigTemplate_8b0d3da2cc402ff26a4ed024be516076 extends Template
{
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
            ...
            <div class=\"sf-toolbar-info-piece\">
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["stack"]) {
                    ...
                    yield "</td>
                                <td>";
                    // line 36
                    yield ((CoreExtension::getAttribute($this->env, $this->source, $context["stack"], "failed", [], "any", false, false, false, 36)) ? ("FAILED") : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["stack"], "responseCode", [], "any", true, true, false, 36)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["stack"], "responseCode", [], "any", false, false, false, 36), "n/a")) : ("n/a")), "html", null, true)));
                    yield "</td>
                            </tr>
                        ";
                }
        ...
        ";
            // line 44
            yield from $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "@Httplug/webprofiler.html.twig", 44)->unwrap()->yield(CoreExtension::merge($context, ["link" => (isset($context["profiler_url"]) || array_key_exists("profiler_url", $context) ? $context["profiler_url"] : (function () { throw new RuntimeError('Variable "profiler_url" does not exist.', 44, $this->source); })()), "status" => ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 44, $this->source); })()), "failedStacks", [], "any", false, false, false, 44))) ? ("red") : (""))]));
            // line 45
            yield "    ";
        }
...
";
    ...
    public function block_menu(array $context, array $blocks = []): iterable
    {
        ...
        yield " ";
        yield ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 60, $this->source); })()), "failedStacks", [], "any", false, false, false, 60))) ? ("label-status-error") : (""));
        yield "\">
        <span class=\"icon\">
            ";
        // line 62
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["client"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["stack"]) {
                ...
                yield "                    <div class=\"httplug-stack\">
                        ";
                // line 85
                yield from $this->loadTemplate("@Httplug/stack.html.twig", "@Httplug/webprofiler.html.twig", 85)->unwrap()->yield(CoreExtension::toArray(["collector" =>                 // line 86
...
{% endblock %}
", "@Httplug/webprofiler.html.twig", "C:\\Users\\lamfa\\Bureau\\stgja\\vendor\\php-http\\httplug-bundle\\src\\Resources\\views\\webprofiler.html.twig");
    }
}
