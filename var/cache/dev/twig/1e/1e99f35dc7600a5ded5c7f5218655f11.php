...
class __TwigTemplate_1eb0d40647f2b39d0f6b28dc04d30a0b extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/tarif/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/tarif/index.html.twig"));

        $this->parent = $this->loadTemplate("layout/admin.html.twig", "admin/tarif/index.html.twig", 1);
  ...
  <div class=\"row mb-4\">
    <div class=\"col-lg-9 col-9\">
      <h1 class=\"page-name\">
        ...
        ";
        // line 9
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Tarifs"), "html", null, true);
        yield "
      </h1>
    </div>
    <div class=\"col-lg-3 col-3\">
      <div class=\"float-end\">
        ...
        <a href=\"";
            // line 15
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("tarifs.create");
            yield "\" class=\"add-new\">
  ...
  ";
        ...
        if ( !CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 26, $this->source); })()), "request", [], "any", false, false, false, 26), "get", ["sortable"], "method", false, false, false, 26)) {
            // line 27
            yield "    ";
            yield from $this->loadTemplate("layout/form/search/index.html.twig", "admin/tarif/index.html.twig", 27)->unwrap()->yield(CoreExtension::merge($context, ["form" =>             // line 28
(isset($context["search_form"]) || array_key_exists("search_form", $context) ? $context["search_form"] : (function () { throw new RuntimeError('Variable "search_form" does not exist.', 28, $this->source); })()), "tableId" => "tarifs"]));
            // line 31
            yield "  ";
        }
        // line 32
        yield "
  <ajax-table id=\"tarifs\" url=\"";
        // line 33
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("tarifs.table");
        yield "\" ";
...
{% block body %}
  ...
  <div class=\"row mb-4\">
    ...
    <div class=\"col-lg-3 col-3\">
      <div class=\"float-end\">
        ...
        <a href=\"{{ path('tarifs.create') }}\" class=\"add-new\">
          <button class=\"btn btn-outline-primary rounded-0 shadow-none\">
            <i class=\"bi bi-plus\"></i>
  ...
  <ajax-table id=\"tarifs\" url=\"{{ path('tarifs.table') }}\" {% if app.request.get('sortable') %}sortable=\"tarifs\"{% endif %}>
    {{ table|raw }}
  </ajax-table>
