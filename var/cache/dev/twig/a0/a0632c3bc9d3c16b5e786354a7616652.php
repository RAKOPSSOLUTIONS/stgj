...
class __TwigTemplate_6148394fa992785cf5f5962bda45bed5 extends Template
{
  ...
  <div class=\"row mb-4\">
    <div class=\"col-lg-9 col-9\">
      <h1 class=\"page-name\">
        ...
        ";
        // line 9
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Options"), "html", null, true);
        yield "
      </h1>
    </div>
    <div class=\"col-lg-3 col-3\">
      <div class=\"float-end\">
        <a href=\"";
        // line 14
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categories.create");
        yield "\" class=\"add-new\">
  ...
  ";
        ...
        if ( !CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 24, $this->source); })()), "request", [], "any", false, false, false, 24), "get", ["sortable"], "method", false, false, false, 24)) {
            // line 25
            yield "    ";
            yield from $this->loadTemplate("layout/form/search/index.html.twig", "admin/category/index.html.twig", 25)->unwrap()->yield(CoreExtension::merge($context, ["form" =>             // line 26
(isset($context["search_form"]) || array_key_exists("search_form", $context) ? $context["search_form"] : (function () { throw new RuntimeError('Variable "search_form" does not exist.', 26, $this->source); })()), "tableId" => "categories"]));
            // line 29
            yield "  ";
        }
        // line 30
  ...
  <ajax-table id=\"categories\" url=\"";
        // line 31
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categories.table");
        yield "\" ";
