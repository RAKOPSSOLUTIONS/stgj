 ...
 */
class getSecurity_Listener_UserChecker_SecuredAreaService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.listener.user_checker.secured_area' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.user_checker.secured_area'] = new \Symfony\Component\Security\Http\EventListener\UserCheckerListener(($container->services['hwi_oauth.user_checker'] ?? ($container->services['hwi_oauth.user_checker'] = new \Symfony\Component\Security\Core\User\InMemoryUserChecker())));
    }
}
