 ...
 */
class getMailHistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MailHistoryRepository.php';
        ...
        if (isset($container->privates['App\\Repository\\MailHistoryRepository'])) {
            return $container->privates['App\\Repository\\MailHistoryRepository'];
        }
        ...
        }, 4)))->fromStrings(['main' => $container->getEnv('MAILER_DSN')]), NULL, $a));
    }
}
